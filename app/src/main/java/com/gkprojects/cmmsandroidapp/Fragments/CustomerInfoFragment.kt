...
class CustomerInfoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        getUserDetails(tempUserID)

        val signatureView = SignatureView(requireContext())
        val args =this.arguments
        if( args!=null){
            reportId = args.getInt("reportId")
    ...
    private fun getUserDetails(userId:Int) {
        usersViewModel.getSingleUser(requireContext(),userId).observe(viewLifecycleOwner,Observer{
    ...
    private fun insertDb() {
        ...
        val insertFieldReport =FieldReports(null,null,reportNumber,report,startDate,closedDate,subject,department,clientName,selectedState,clientSignature,reportCostValue,lastModified,dateCreated,version,customerId,contractId,userId,caseId)
