...
class CheckFormsFragment : Fragment() {
    ...
    private fun showDialog(maintenanceId : Int ) {
        ...
        btn.setOnClickListener {
            val temp= CheckForms(null,null,maintenanceId,descriptionEditText.text.toString(),expectedValuesEditText.text.toString(),valueTypeEditText.text.toString(),null,null,null)
        ...
        AlertDialog.Builder(context)
            ...
            .setPositiveButton("OK") { _, _ ->
                ...
                val description = descriptionEditText.text.toString()
                val expectedValues = expectedValuesEditText.text.toString()
